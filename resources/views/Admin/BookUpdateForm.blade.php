...
<div class="row">
 ...
 <form  method="post" class="form-horizontal">
  ...
  <div class="form-group">
   ...
   <div class="col-sm-8"><input type="text" name='BookNameI' class="form-control" value='{{$book->BookName}}'></div>
  </div> 

  <!-- Book Pic -->
  <div class="form-group">
   <div class="col-sm-2"><label for="BookPicI" class="form-label">Book 3ilaf:</label></div>
   <div class="col-sm-8"><input type="text" name="BookPicI"  class="form-control" value='{{$book->BookPic}}'></div>
  </div>
  ...
  <div class="form-group">
   ...
   <div class="col-sm-8"><input type="text" name="BookLinkI"  class="form-control" value='{{$book->BookLink}}'></div>
  </div>
  ...
  <div class="form-group">
   ...
   <div class="col-sm-8"><input type="text" name='BookLangI' class="form-control" value='{{$book->BookLang}}'></div>
  </div>

 <!-- Pages Number -->
 <div class="form-group">
   <div class="col-sm-2"><label for="BookPagesNumI" class="form-label">Book Pages Number:</label></div>
   <div class="col-sm-8"><input type="text" name='BookPagesNumI' class="form-control" value='{{$book->BookPagesNum}}'></div>
  </div>

    <!-- Book size -->
  <div class="form-group">
   <div class="col-sm-2"><label for="BookSizeI" class="form-label">Book Size:</label></div>
   <div class="col-sm-8"><input type="text" name='BookSizeI' class="form-control" value='{{$book->BookSize}}'></div>
  </div>  

    <!-- Book Relase Date  -->
    <div class="form-group">
   <div class="col-sm-2"><label for="BookRelaseDateI" class="form-label">Book relase Date:</label></div>
   <div class="col-sm-8"><input type="date" name='BookRelaseDateI' class="form-control" value='{{$book->BookRelaseDate}}'></div>
  </div>
  <!-- submit  -->
  <div class="form-group">
